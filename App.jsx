...
import { 
  ...
  MessageCircle, LayoutDashboard, LogOut, ChevronRight, CheckCircle2, AlertCircle, Scan
} from 'lucide-react';
    ...
    <div className="p-6 space-y-6 animate-in fade-in slide-in-from-bottom-4">
      ...
      <div className="bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm">
        <div className="flex justify-between items-center mb-4">
          <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest">मेरी फसलें</h4>
      ...
      <aside className="w-full lg:w-64 bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm h-fit sticky top-24">
        ...
        <nav className="space-y-1">
          {[
            ...
            { id: 'product', label: 'प्रोडक्ट', icon: Box },
            { id: 'purchase', label: 'ख
